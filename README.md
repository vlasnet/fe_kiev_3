...
Repository for homeworks "GoFrontend#3: Offline". Mentor: Bondarenko Misha
...
1. Делаете `Fork` данного проекта https://github.com/bondarenkoMisha/fe_kiev_3 как описано в статье
...
8. Выбираете ветку с вашим ДЗ и жмёте `New pull request` или, если у Вас появилась кнопка `Compare & pull request`, жмёте её: 
...
- 9.1. `base fork:` указываете `bondarenkoMisha/fe_kiev_3`, а `base:` ветку `dz_4` (Для ДЗ № 4 соответственно)
